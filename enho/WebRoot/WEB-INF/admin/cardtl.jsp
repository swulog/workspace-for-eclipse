...
<body>
	<table style="width:100%;">
		...
		<tr>
			<td><label for="name" style="font-size:12px;">载量：</label></td> 
			<td><label for="name" style="font-size:12px;">${weight}</label></td>
			<td><label for="name" style="font-size:12px;">车长：</label></td>
			<td><label for="name" style="font-size:12px;">${carlength}:</label></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label for="name" style="font-size:12px;">备注</label></td>
			<td><label for="name" style="font-size:12px;">${remark}</label></td>
		</tr>
		<tr>
			<td><label for="name" style="font-size:12px;">描述：</label></td> 
			<td><label for="name" style="font-size:12px;">${desc}</label></td>
			<td><label for="name" style="font-size:12px;">车牌号</label></td>
			<td><label for="name" style="font-size:12px;">${carno}</label></td>
		</tr>
	</table>
</body>
</html>
