...
<body>
	<table style="width:100%;">
		...
		<tr>
			<td><label for="name" style="font-size:12px;">组id：</label></td> 
			<td><label for="name" style="font-size:12px;">${groupid}</label></td>
			<td><label for="name" style="font-size:12px;">组名称：</label></td>
			<td><label for="name" style="font-size:12px;">${groupname}</label></td>
		</tr>
		<tr>
		...
		<tr>
			<td valign="top"><label for="name" style="font-size:12px;">修改时间：</label></td>
			<td valign="top"><label for="name" style="font-size:12px;">${lastupdatetime}</label></td>
