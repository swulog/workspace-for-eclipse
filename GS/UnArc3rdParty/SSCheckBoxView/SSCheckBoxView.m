...
//    NSString *str0 = [[NSBundle mainBundle] resourcePath];
//    NSString *str1 = [str0 stringByAppendingPathComponent:@"Graphics.bundle"];
//    NSBundle *ibundle = [NSBundle bundleWithPath:str1];
    NSBundle *bundle = [NSBundle bundleWithPath:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"Graphics.bundle"]];
	NSString * strPath = [bundle pathForResource:imageName ofType:@"png"];
	UIImage *storyMenuItemImage = [UIImage imageWithContentsOfFile:strPath];
