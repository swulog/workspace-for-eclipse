...
typedef enum {
    ...
    CInputAssistViewPerviousAndNextAndDone,//上一个 下一个 确定
    CInputAssistViewPerviousAndDone,//上一个  确定
    CInputAssistViewAll,//前一个 后一个 取消 确定
     CInputAssistViewHide,
    CInputAssistViewPerDoneHide,
    CInputAssistViewNextHide,
    CInputAssistViewPerNextHide,
