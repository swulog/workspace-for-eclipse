...
//normal text font
#define kTextFont [UIFont fontWithName:@"HelveticaNeue" size:12.0f]
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    [UIView animateWithDuration:0.2f delay:0.f options:UIViewAnimationOptionCurveEaseInOut/*UIViewAnimationCurveEaseInOut*/ animations:^{
        self.alpha = 1.f;
...
- (void)showImage:(UIImage *)image withMessage:(NSString *)msg {
    ...
    [UIView animateWithDuration:0.2f delay:0.2f options:UIViewAnimationOptionCurveEaseOut/*UIViewAnimationCurveEaseOut*/ animations:^{
        imageView.alpha = 1.f;
...
- (void)showError {
    ...
    [UIView animateWithDuration:0.1f delay:0.1f options:UIViewAnimationOptionCurveEaseOut/*UIViewAnimationCurveEaseOut*/ animations:^{
        imageView.alpha = 1.f;
        imageView.transform = CGAffineTransformIdentity;
    } completion:^(BOOL finished) {
        //[imageView removeFromSuperview];
